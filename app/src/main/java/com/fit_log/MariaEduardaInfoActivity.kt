...
fun UserInfo(modifier: Modifier = Modifier) {
    Column(
        ...
        // Título
        Text(
            text = "Informações de Maria Eduarda",
        ...
        Box(
            ...
            Image(
                painter = painterResource(id = R.drawable.maria_eduarda), // Nome da imagem
        ...
        InfoCard(label = "Nome", value = "Maria Eduarda")
        InfoCard(label = "Idade", value = "21 anos")
        InfoCard(label = "Curso", value = "Ciência da Computação")
        InfoCard(label = "Faculdade", value = "UNICAP")
    }
}
